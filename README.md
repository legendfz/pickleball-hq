...
Your Pickleball Command Center — a full-stack mobile app for tracking professional pickleball players, matches, tournaments, and bracket draws.

![PickleballHQ](https://img.shields.io/badge/version-1.0.0-green) ![Platform](https://img.shields.io/badge/platform-iOS%20%7C%20Android-blue) ![License](https://img.shields.io/badge/license-MIT-gray)
...
```bash
git clone https://github.com/your-org/pickleballhq.git
cd pickleballhq
