...
// ─── Pickleball Ball Icon ────────────────────────────────────────────────
interface PickleballBallIconProps {
  size?: number;
  opacity?: number;
}

export function PickleballBallIcon({ size = 24, opacity = 1 }: PickleballBallIconProps) {
  const r = size / 2;
  return (
    <Svg width={size} height={size} viewBox="0 0 48 48" opacity={opacity}>
      ...
      {/* Classic pickleball ball seam curves */}
      <Path
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 140 140">
      <G opacity="0.6">
        ...
        {/* Pickleball ball inside magnifier */}
